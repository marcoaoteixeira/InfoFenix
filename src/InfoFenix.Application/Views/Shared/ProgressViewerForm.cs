...
namespace InfoFenix.Application.Views.Shared {
    ...
    public partial class ProgressViewerForm : LayoutForm {
        ...
        private void InitializeDefaultState() {
            ...
            closeButton.Text = Strings.ProgressViewForm_ActionButton_Close;
        }
        ...
        private void StartNotificationHandler(ProgressInfo info) {
            ...
            closeButton.Text = Strings.ProgressViewForm_ActionButton_Cancel;
        }
        ...
        private bool ConfirmTaskCancellation() {
            ...
            var response = MessageBox.Show(Strings.ProgressViewForm_Cancellation_Message,
                Strings.ProgressViewForm_Cancellation_Title,
