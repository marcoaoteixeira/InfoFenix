...
namespace InfoFenix.Client.Views.Home {
    ...
    public partial class SplashScreenForm : Form {
        ...
        private void Initialize() {
            ...
            versionLabel.Text = string.Format(Resource.Display_Version, EntryPoint.ApplicationVersion.Major, EntryPoint.ApplicationVersion.Minor, EntryPoint.ApplicationVersion.Revision);
        }
